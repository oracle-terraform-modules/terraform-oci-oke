...
|Cloudinit common for all nodepools when no specific script mentioned for nodepool in cloudinit_nodepool.
|
|""

|cloudinit_nodepool
|Cloudinit specific to nodepool to override cloudinit_nodepool_common.
|
|{}
