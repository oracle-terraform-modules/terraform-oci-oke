...
variable "cluster_autoscaler_enabled" {
  default     = false
  description = "Whether to deploy the Kubernetes Cluster Autoscaler Helm chart. See https://github.com/kubernetes/autoscaler."
  type        = bool
}
...
variable "prometheus_enabled" {
  default     = false
  description = "Whether to deploy the Prometheus Helm chart. See https://github.com/prometheus-community/helm-charts/tree/main/charts/kube-prometheus-stack."
  type        = bool
}
...
variable "gatekeeper_enabled" {
  default     = false
  description = "Whether to deploy the Gatekeeper Helm chart. See https://github.com/open-policy-agent/gatekeeper."
  type        = bool
}
