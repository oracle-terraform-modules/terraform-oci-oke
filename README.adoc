...
:uri-changelog: {uri-rel-tree-base}CHANGELOG.adoc
:uri-contribute: {uri-rel-tree-base}CONTRIBUTING.adoc
:uri-contributors: {uri-rel-tree-base}CONTRIBUTORS.adoc
:uri-docs: {uri-rel-tree-base}/docs
:uri-instructions: {uri-docs/instructions.adoc}
:uri-license: {uri-rel-tree-base}LICENSE.txt
