...
# OIDC
variable "open_id_connect_discovery_enabled" { type = bool }
variable "open_id_connect_token_auth_enabled" { type = bool }
variable "open_id_connect_token_authentication_config" { type = any }