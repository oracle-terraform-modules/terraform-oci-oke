...
* lb_subnet_type: can be any of both, internal, public. Default is public. This will ensure that the necessary subnets are created. 

* preferred_lb_ads: in multi-AD regions, which Availability Domain you want to place your load balancers e.g. ["ad1, ad2"]

* preferred_lb_subnets: can be internal or public. Default is public This automatically set OKE's preferred load balancer subnets.

The table below shows the possible combinations of preferred_lb_subnets and subnet_type values.
