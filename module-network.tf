...
locals {
  ...
  vcn_ipv6_cidrs         = var.create_vcn ? concat(coalesce(module.vcn[0].vcn_all_attributes["ipv6cidr_blocks"], []), coalesce(module.vcn[0].vcn_all_attributes["byoipv6cidr_blocks"], []), coalesce(module.vcn[0].vcn_all_attributes["ipv6private_cidr_blocks"], [])) : concat(coalesce(data.oci_core_vcn.oke[0].ipv6cidr_blocks, []), coalesce(data.oci_core_vcn.oke[0].byoipv6cidr_blocks, []), coalesce(data.oci_core_vcn.oke[0].ipv6private_cidr_blocks, []))
