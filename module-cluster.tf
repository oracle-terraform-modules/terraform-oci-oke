...
module "cluster" {
  ...
  open_id_connect_discovery_enabled           = var.open_id_connect_discovery_enabled
  open_id_connect_token_auth_enabled          = var.open_id_connect_token_auth_enabled
  open_id_connect_token_authentication_config = var.open_id_connect_token_authentication_config
...
output "cluster_oidc_discovery_endpoint" {
  ...
  value       = var.create_cluster && var.open_id_connect_discovery_enabled ? one(module.cluster[*].cluster.open_id_connect_discovery_endpoint) : null
}
